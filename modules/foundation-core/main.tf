# ===========================================================================
# modules/foundation-core/main.tf
#
# Shared landing-zone logic used by both foundation/standard and
# foundation/hipaa. Callers are responsible for folder creation and pass
# the resolved numeric folder IDs via var.env_folder_numeric_ids.
#
# Provisions: projects, VPCs, subnets, Cloud NAT, monitoring, logging,
# baseline firewall rules, and GCS state buckets for the resources layer.
# ===========================================================================
...
locals {
  # ---------------------------------------------------------------------------
  # APIs enabled on every project. Callers append compliance-specific APIs
  # (e.g. cloudkms, accesscontextmanager) via var.extra_activate_apis.
  # ---------------------------------------------------------------------------
  ...
  # =========================================================================
  # Baseline firewall rules applied to every VPC
  # Covers: IAP SSH/RDP, GCP health checks, internal RFC1918, deny-all.
  # =========================================================================
...
module "shared_common_project" {
  ...
  folder_id       = var.env_folder_numeric_ids[each.value.env]
...
# ===========================================================================
# 3. SHARED VPC MODE — Monitoring & Logging
# ===========================================================================
...
# ===========================================================================
# 4. NON-SHARED VPC MODE — Projects
# ===========================================================================
...
# ===========================================================================
# 5. NON-SHARED VPC MODE — Networking
# ===========================================================================
...
# ===========================================================================
# 6. NON-SHARED VPC MODE — Monitoring & Logging
# ===========================================================================
...
# ===========================================================================
# 8. GCS State Buckets for the Resources Layer
# ===========================================================================
...
module "resource_state_buckets" {
  ...
  labels = merge(var.labels, {
    compliance-regime = var.compliance_regime
  })
